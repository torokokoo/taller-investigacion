...
from optuna.visualization import plot_optimization_history, plot_param_importances, plot_hypervolume_history
...
def evaluate_agent(model, num_episodes=20):
    test_env = gym.make("MountainCar-v0", render_mode="rgb_array", goal_velocity=0.1)
...
def objective(trial):
    ...
    gamma = trial.suggest_float("gamma", 0.10, 0.15)
...
def main():
    ...
    study = optuna.create_study(
        direction="maximize",
        study_name="mountain_car_ppo_optimization",
    ...
    try:
        ...
        fig3 = plot_hypervolume_history(study)
        fig3.write_image("Resultados/OptunaFrozenPPO/hypervolume_history.png")
